...
After experimenting with signals with a few controlled frequencies, we generated stochastic signals, using a technique known as Perlin Noise \cite{perlin-1985}. 
