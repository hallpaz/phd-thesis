...
% As we saw in Chapter \ref{chap:sinusoidal}, this architecture acts as a spectral filter that selects specific frequencies from the input signal based on the initialization of \( W_s \).
