...
To illustrate the multiresolution capabilities of the network, we now present an experiment using a "Cameraman" image. The image is a monochrome photograph with a resolution of \(512 \times 512\) pixels.
