...
\citet{paz2022} have showcased the MRNet's capabilities in encoding mip-mapping \cite{mipmap83} and presenting an anti-aliased version of an image, adapted to the required resolution. Consequently, we can use our method to evaluate a multiresolution INR at any coordinate and achieve similar anti-aliasing effects. Figure \ref{f:alias} shows the texture mapping results with and without anti-aliasing treatment utilizing a periodic M-Net \cite{paz2023mr} with 5 stages.
