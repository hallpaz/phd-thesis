\chapter{MR-Net Architecture}\label{sec:mr_snn}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.96\linewidth]{img/ch4n/mr-net-stages-v2.png}
...
\includegraphics[width=\linewidth]{img/ch4n/diagram_mr_module.pdf}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.8\linewidth]{img/ch4n/pure-sine.png}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.9\linewidth]{img/ch4n/modulated-sine.png}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.58\linewidth]{img/ch4n/snet.pdf}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.7\linewidth]{img/ch4n/lnet.pdf}
% \vspace{-0.4cm}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.75\linewidth]{img/ch4n/mnet.pdf}
% \vspace{-0.4cm}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.7\linewidth]{img/ch4n/nyquist.png}
\vspace{-0.3cm}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.99\linewidth]{img/ch4n/mr-net-components.png}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.89\linewidth]{img/ch4n/mr-structure.png}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.8\linewidth]{img/ch4n/attrib-d0-d1.png}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.8\linewidth]{img/ch4n/attrib-mask.png}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.45\linewidth]{img/ch4n/regular.png}
\hfil
\includegraphics[width=0.45\linewidth]{img/ch4n/poisson.png}
\\
...
\includegraphics[width=\linewidth]{img/ch4n/pyramid.png}
\caption{Pyramid}
\end{subfigure}
\begin{subfigure}{0.49\linewidth}
\includegraphics[width=\linewidth]{img/ch4n/tower.png}    
\caption{Tower}
\end{subfigure}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.32\linewidth]{img/ch4n/signal.png}
\includegraphics[width=0.32\linewidth]{img/ch4n/gaussian.png}
\includegraphics[width=0.32\linewidth]{img/ch4n/laplacian.png}\\
...
% % \begin{figure}[!h]
% % \centering
% % \includegraphics[width=0.42\linewidth]{img/ch4n/regular.png}
% % \hfil
% % \includegraphics[width=0.42\linewidth]{img/ch4n/poisson.png}
% % \\
...
% % \begin{figure}[!h]
% % \centering
% % \includegraphics[width=0.30\linewidth]{img/ch4n/signal.png}
% % \includegraphics[width=0.30\linewidth]{img/ch4n/gaussian.png}
% % \includegraphics[width=0.30\linewidth]{img/ch4n/laplacian.png}\\
% % {\hfil \hfil signal \hfil \hfil \hfil low-pass \hfil \hfil \hfil band-pass \hfil}
...
% % \begin{figure}[!h]
% % \centering
% % \includegraphics[width=0.45\linewidth]{img/ch4n/tower.png}
% % \includegraphics[width=0.45\linewidth]{img/ch4n/pyramid.png}\\
...
% \begin{figure}[!h]
% \centering
% \includegraphics[width=0.3\linewidth]{img/ch4n/mr-stages.png}
% \caption{MR-Stages}
% \label{f:stages}
% \end{figure}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.89\linewidth]{img/ch4n/training.png}
\caption{MR-Training.}
\label{f:training}
\end{figure}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\linewidth]{img/ch4n/capacity-filtering.png}
% \vspace{-0.4cm}
